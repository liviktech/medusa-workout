...
var assignSystemProviderToTaxRegionsWorkflow = (0, workflows_sdk_1.createWorkflow)("assign-system-provider-to-tax-regions", function () {
    var taxRegions = (0, core_flows_1.useQueryGraphStep)({
        entity: "tax_region",
        fields: ["id", "provider_id", "province_code"],
    }).data;
    var updateData = (0, workflows_sdk_1.transform)({ taxRegions: taxRegions }, function (_a) {
        var taxRegions = _a.taxRegions;
        /**
         * Update only parent regions that don't have a provider set.
         */
        return taxRegions
            .filter(function (taxRegion) { return !taxRegion.province_code && !taxRegion.provider_id; })
            .map(function (taxRegion) { return ({
            id: taxRegion.id,
...
function assignTaxSystemProviderToTaxRegions(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _c.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, assignSystemProviderToTaxRegionsWorkflow(container).run()];
                case 2:
                    _c.sent();
