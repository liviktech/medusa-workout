...
function setTaxContext() {
    ...
    return function (req, _, next) { return __awaiter(_this, void 0, void 0, function () {
        var withCalculatedPrice, inclusivity, taxLinesContext, e_1;
...
var getTaxInclusivityInfo = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var region;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, http_1.refetchEntity)("region", req.filterableFields.region_id, req.scope, ["automatic_taxes"])];
            case 1:
                region = _a.sent();
                if (!region) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, "Region with id ".concat(req.filterableFields.region_id, " not found when populating the tax context"));
                }
                return [2 /*return*/, {
...
var getTaxLinesContext = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var taxContext;
    return __generator(this, function (_a) {
