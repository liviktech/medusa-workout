...
function transformAndValidateSalesChannelIds(req) {
    var _a = req.publishable_key_context.sales_channel_ids, idsFromPublishableKey = _a === void 0 ? [] : _a;
    var _b = req.validatedQuery.sales_channel_id, idsFromRequest = _b === void 0 ? [] : _b;
    ...
    if (idsFromRequest.length) {
        var uniqueInParams = (0, utils_1.arrayDifference)(idsFromRequest, idsFromPublishableKey);
    ...
    if (idsFromPublishableKey === null || idsFromPublishableKey === void 0 ? void 0 : idsFromPublishableKey.length) {
...
function filterByValidSalesChannels() {
    ...
    return function (req, _, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            salesChannelIds = transformAndValidateSalesChannelIds(req);
