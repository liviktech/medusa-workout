...
function normalizeDataForContext() {
    ...
    return function (req, _, next) { return __awaiter(_this, void 0, void 0, function () {
        var calculatedPriceIndex, withCalculatedPrice, regionId, countryCode, province, cart, stores;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    calculatedPriceIndex = req.queryConfig.fields.findIndex(function (field) {
                        return field.startsWith("variants.calculated_price");
                    });
                    withCalculatedPrice = false;
                    ...
                    regionId = req.filterableFields.region_id;
                    countryCode = req.filterableFields.country_code;
                    province = req.filterableFields.province;
                    if (!req.filterableFields.cart_id) return [3 /*break*/, 2];
                    return [4 /*yield*/, (0, http_1.refetchEntity)("cart", req.filterableFields.cart_id, req.scope, ["region_id", "shipping_address.*"])];
                case 1:
                    cart = _b.sent();
                    if (cart === null || cart === void 0 ? void 0 : cart.region_id) {
                        regionId = cart.region_id;
                    }
                    if (cart === null || cart === void 0 ? void 0 : cart.shipping_address) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, http_1.refetchEntities)("store", {}, req.scope, [
                            "default_region_id",
                        ])];
                case 3:
                    stores = _b.sent();
                    regionId = (_a = stores[0]) === null || _a === void 0 ? void 0 : _a.default_region_id;
                    _b.label = 4;
                case 4:
                    if (!regionId) {
                        try {
