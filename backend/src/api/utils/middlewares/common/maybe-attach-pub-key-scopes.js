 ...
 */
function maybeAttachPublishableKeyScopes(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var pubKey, remoteQuery, queryObject, apiKey;
        var _a;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    req.publishableApiKeyScopes = {
                        sales_channel_ids: (_a = apiKey === null || apiKey === void 0 ? void 0 : apiKey.sales_channels.map(function (sc) { return sc.id; })) !== null && _a !== void 0 ? _a : [],
                    };
                    _b.label = 2;
                case 2:
                    next();
