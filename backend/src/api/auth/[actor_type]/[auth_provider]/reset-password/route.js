...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, auth_provider, actor_type, identifier, http;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, auth_provider = _a.auth_provider, actor_type = _a.actor_type;
                ...
                return [4 /*yield*/, (0, core_flows_1.generateResetPasswordTokenWorkflow)(req.scope).run({
                        input: {
                            entityId: identifier,
