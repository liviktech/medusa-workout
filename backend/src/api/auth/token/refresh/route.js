...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var service, authIdentity, http, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                service = req.scope.resolve(utils_1.Modules.AUTH);
                return [4 /*yield*/, service.retrieveAuthIdentity(req.auth_context.auth_identity_id)];
            case 1:
                authIdentity = _a.sent();
                http = req.scope.resolve(utils_1.ContainerRegistrationKeys.CONFIG_MODULE).projectConfig.http;
                token = (0, generate_jwt_token_1.generateJwtTokenForAuthIdentity)({ authIdentity: authIdentity, actorType: req.auth_context.actor_type }, {
