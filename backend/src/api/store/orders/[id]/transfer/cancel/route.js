...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, customerId, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderId = req.params.id;
                customerId = req.auth_context.actor_id;
                return [4 /*yield*/, (0, core_flows_1.cancelOrderTransferRequestWorkflow)(req.scope).run({
                        input: {
                            order_id: orderId,
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, core_flows_1.getOrderDetailWorkflow)(req.scope).run({
                        input: {
