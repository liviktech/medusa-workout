...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, regionPaymentProvidersRelation, metadata, paymentProviders;
        ...
        switch (_b.label) {
            case 0:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: __assign({ filters: {
                            region_id: req.filterableFields.region_id,
                        } }, req.queryConfig.pagination),
                    fields: req.queryConfig.fields.map(function (f) { return "payment_provider.".concat(f); }),
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 1:
                _a = _b.sent(), regionPaymentProvidersRelation = _a.rows, metadata = _a.metadata;
                paymentProviders = regionPaymentProvidersRelation.map(function (relation) { return relation.payment_provider; });
                res.json({
