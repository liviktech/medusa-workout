...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createCustomers, customerData, result, customer;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, createCustomers.run({
                        input: { customerData: customerData, authIdentityId: req.auth_context.auth_identity_id },
                    })];
            case 1:
                result = (_a.sent()).result;
                return [4 /*yield*/, (0, helpers_1.refetchCustomer)(result.id, req.scope, req.queryConfig.fields)];
            case 2:
                customer = _a.sent();
