...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.addDraftOrderPromotionWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { order_id: id }),
                    })];
            case 1:
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.removeDraftOrderPromotionsWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { order_id: id }),
                    })];
            case 1:
                result = (_a.sent()).result;
