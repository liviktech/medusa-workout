    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, core_flows_1.updateDraftOrderActionItemWorkflow)(req.scope).run({
                        input: {
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, id = _a.id, action_id = _a.action_id;
                return [4 /*yield*/, (0, core_flows_1.removeDraftOrderActionItemWorkflow)(req.scope).run({
                        input: {
                            order_id: id,
                            action_id: action_id,
                        },
