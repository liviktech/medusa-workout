...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                workflow = (0, core_flows_1.getOrderDetailWorkflow)(req.scope);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, core_flows_1.updateDraftOrderWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { user_id: req.auth_context.actor_id, id: req.params.id }),
                    })];
            case 1:
                _a.sent();
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.deleteDraftOrdersWorkflow)(req.scope).run({
                        input: {
                            order_ids: [id],
                        },
                    })];
