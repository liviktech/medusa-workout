...
var AdminGetDraftOrdersParamsFields = zod_1.z.object({
...
var CreateDraftOrder = zod_1.z
    ...
    .strict();
exports.AdminCreateDraftOrder = (0, validators_1.WithAdditionalData)(CreateDraftOrder, function (schema) {
...
exports.AdminAddDraftOrderItems = zod_1.z.object({
    items: zod_1.z
        ...
        .refine(function (items) {
        return items.every(function (item) { return item.variant_id || item.title; });
    }, {
