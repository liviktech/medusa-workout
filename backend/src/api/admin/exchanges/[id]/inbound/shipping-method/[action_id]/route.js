...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, action_id, remoteQuery, exchange, result, queryObject, orderExchange;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                exchange = (_b.sent())[0];
                return [4 /*yield*/, (0, core_flows_1.updateReturnShippingMethodWorkflow)(req.scope).run({
                        input: {
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, _a, id, action_id, exchange, orderPreview, queryObject, orderReturn;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
            ...
            case 1:
                exchange = (_b.sent())[0];
                return [4 /*yield*/, (0, core_flows_1.removeReturnShippingMethodWorkflow)(req.scope).run({
                        input: {
                            return_id: exchange.return_id,
                            action_id: action_id,
                        },
