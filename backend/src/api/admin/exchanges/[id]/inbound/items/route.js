...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, exchange, result, returnId, queryObject, orderReturn;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                exchange = (_a.sent())[0];
                return [4 /*yield*/, (0, core_flows_1.orderExchangeRequestItemReturnWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { return_id: exchange.return_id, exchange_id: id }),
                    })];
            case 2:
                result = (_a.sent()).result;
                returnId = result.order_change.return_id;
