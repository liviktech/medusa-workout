...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.cancelOrderExchangeWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: __assign(__assign({}, req.validatedBody), { exchange_id: id, canceled_by: req.auth_context.actor_id }),
                    })];
            case 1:
