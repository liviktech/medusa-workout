...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, exchanges, metadata;
        ...
        switch (_b.label) {
            case 0:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: __assign({ filters: __assign({}, req.filterableFields) }, req.queryConfig.pagination),
                    fields: req.queryConfig.fields,
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 1:
                _a = _b.sent(), exchanges = _a.rows, metadata = _a.metadata;
                res.json({
                    exchanges: exchanges,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, remoteQuery, orderModuleService, workflow, result, queryObject, _a, order, orderExchange;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                input = __assign(__assign({}, req.validatedBody), { created_by: req.auth_context.actor_id });
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                orderModuleService = req.scope.resolve(utils_1.Modules.ORDER);
                workflow = (0, core_flows_1.beginExchangeOrderWorkflow)(req.scope);
            ...
            case 1:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: {
                        ...
                        filters: __assign({}, req.filterableFields),
                    },
                    fields: req.queryConfig.fields,
                });
            ...
            case 2:
                _a = _b.sent(), order = _a[0], orderExchange = _a[1];
                res.json({
                    order: order,
