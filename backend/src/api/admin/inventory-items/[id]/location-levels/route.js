...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, query, _a, inventory_levels, metadata;
        ...
        switch (_b.label) {
            case 0:
                ...
                query = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: __assign({ filters: __assign(__assign({}, req.filterableFields), { inventory_item_id: id }) }, req.queryConfig.pagination),
