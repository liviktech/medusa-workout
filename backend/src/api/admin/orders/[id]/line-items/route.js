...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, query, result, data, deduplicatedItems, _i, data_1, item, itemId, version;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, query.graph({
                        entity: "order_items",
                        filters: __assign(__assign({}, req.filterableFields), { order_id: id }),
            ...
            case 1:
                ...
                for (_i = 0, data_1 = data; _i < data_1.length; _i++) {
                    ...
                    if (!deduplicatedItems[itemId]) {
                        deduplicatedItems[itemId] = __assign(__assign({}, item), { history: {
                                version: {
                                    from: version,
                                    to: version,
                                },
                    ...
                    if (version > deduplicatedItems[itemId].version) {
                        deduplicatedItems[itemId] = __assign(__assign({}, item), { history: deduplicatedItems[itemId].history });
                    }
                }
                res.json({
