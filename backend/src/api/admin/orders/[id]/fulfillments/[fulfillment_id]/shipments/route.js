...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, input, queryObject, order;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                input = __assign(__assign({}, req.validatedBody), { order_id: req.params.id, fulfillment_id: req.params.fulfillment_id, labels: (_a = req.validatedBody.labels) !== null && _a !== void 0 ? _a : [] });
                return [4 /*yield*/, (0, core_flows_1.createOrderShipmentWorkflow)(req.scope).run({
                        input: input,
                    })];
            case 1:
                _b.sent();
