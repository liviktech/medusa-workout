    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                input = __assign(__assign({}, req.validatedBody), { order_id: req.params.id, fulfillment_id: req.params.fulfillment_id, canceled_by: req.auth_context.actor_id });
                return [4 /*yield*/, (0, core_flows_1.cancelOrderFulfillmentWorkflow)(req.scope).run({
                        input: input,
                    })];
            case 1:
                _a.sent();
