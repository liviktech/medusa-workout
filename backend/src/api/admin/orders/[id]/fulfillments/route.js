...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, order;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                return [4 /*yield*/, (0, core_flows_1.createOrderFulfillmentWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { order_id: req.params.id }),
                    })];
            case 1:
                _a.sent();
