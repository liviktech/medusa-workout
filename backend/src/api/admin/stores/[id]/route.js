...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, queryObject, store;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var existingStore, result, store;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, helpers_1.refetchStore)(req.params.id, req.scope, ["id"])];
            case 1:
                existingStore = _a.sent();
                if (!existingStore) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "Store with id \"".concat(req.params.id, "\" not found"));
                }
                return [4 /*yield*/, (0, core_flows_1.updateStoresWorkflow)(req.scope).run({
                        input: {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchStore)(result[0].id, req.scope, req.queryConfig.fields)];
            case 3:
                store = _a.sent();
                res.status(200).json({ store: store });
                return [2 /*return*/];
