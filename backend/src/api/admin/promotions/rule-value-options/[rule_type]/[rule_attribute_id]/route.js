...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, ruleType, ruleAttributeId, promotionType, applicationMethodType, queryConfig, remoteQuery, filterableFields, _b, rows, metadata, values;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.params, ruleType = _a.rule_type, ruleAttributeId = _a.rule_attribute_id, promotionType = _a.promotion_type, applicationMethodType = _a.application_method_type;
                ...
                return [4 /*yield*/, remoteQuery((0, utils_1.remoteQueryObjectFromString)({
                        ...
                        variables: __assign({ filters: filterableFields }, req.queryConfig.pagination),
                        fields: [queryConfig.labelAttr, queryConfig.valueAttr],
                    }))];
            case 1:
                _b = _c.sent(), rows = _b.rows, metadata = _b.metadata;
