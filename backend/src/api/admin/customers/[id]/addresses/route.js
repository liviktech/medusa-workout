        ...
        switch (_b.label) {
            case 0:
                ...
                query = (0, utils_1.remoteQueryObjectFromString)({
                    ...
                    variables: __assign({ filters: __assign(__assign({}, req.filterableFields), { customer_id: customerId }) }, req.queryConfig.pagination),
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, additional_data, rest, customerId, createAddresses, addresses, customer;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                addresses = [
                    __assign(__assign({}, rest), { customer_id: customerId }),
                ];
                return [4 /*yield*/, createAddresses.run({
                        input: { addresses: addresses, additional_data: additional_data },
                    })];
            case 1:
                _b.sent();
                return [4 /*yield*/, (0, helpers_1.refetchCustomer)(customerId, req.scope, req.queryConfig.fields)];
            case 2:
                customer = _b.sent();
