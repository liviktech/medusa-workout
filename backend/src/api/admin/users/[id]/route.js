...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, helpers_1.refetchUser)(req.params.id, req.scope, req.queryConfig.fields)];
            case 2:
                user = _a.sent();
                res.status(200).json({ user: user });
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                workflow = (0, core_flows_1.removeUserAccountWorkflow)(req.scope);
