...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var featureFlagRouter, flags, featureFlags;
    return __generator(this, function (_a) {
        featureFlagRouter = req.scope.resolve(utils_1.ContainerRegistrationKeys.FEATURE_FLAG_ROUTER);
        flags = featureFlagRouter.listFlags();
        featureFlags = {};
