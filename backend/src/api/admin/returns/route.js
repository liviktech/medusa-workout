...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, returns, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), returns = _a.rows, metadata = _a.metadata;
                res.json({
                    returns: returns,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, remoteQuery, orderModuleService, workflow, result, queryObject, _a, order, orderReturn;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                workflow = (0, core_flows_1.beginReturnOrderWorkflow)(req.scope);
            ...
            case 2:
                _a = _b.sent(), order = _a[0], orderReturn = _a[1];
                res.json({
                    order: order,
