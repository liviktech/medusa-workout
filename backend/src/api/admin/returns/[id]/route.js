...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, queryObject, orderReturn;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, result, queryObject, orderReturn;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                return [4 /*yield*/, (0, core_flows_1.updateReturnWorkflow)(req.scope).run({
                        input: __assign({ return_id: id }, req.validatedBody),
                    })];
            case 1:
