...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, orderModuleService, id, workflow, result, queryObject, _a, order, orderReturn;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                id = req.params.id;
                workflow = (0, core_flows_1.beginReceiveReturnWorkflow)(req.scope);
                return [4 /*yield*/, workflow.run({
                        input: __assign(__assign({}, req.validatedBody), { return_id: id }),
                    })];
            case 1:
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.cancelReturnReceiveWorkflow)(req.scope).run({
                        input: {
                            return_id: id,
                        },
                    })];
