...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, claim, result, returnId, queryObject, orderReturn;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                claim = (_a.sent())[0];
                return [4 /*yield*/, (0, core_flows_1.orderClaimRequestItemReturnWorkflow)(req.scope).run({
                        input: __assign(__assign({}, req.validatedBody), { return_id: claim.return_id, claim_id: id }),
                    })];
            case 2:
