...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, action_id, remoteQuery, claim, result, queryObject, orderClaim;
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, _a, id, action_id, claim, orderPreview, queryObject, orderReturn;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
            ...
            case 1:
                claim = (_b.sent())[0];
                return [4 /*yield*/, (0, core_flows_1.removeClaimShippingMethodWorkflow)(req.scope).run({
                        input: {
                            claim_id: claim.id,
                            action_id: action_id,
                        },
