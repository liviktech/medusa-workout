...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, result, queryObject, orderClaim, orderReturn, orderReturnData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                return [4 /*yield*/, (0, core_flows_1.confirmClaimRequestWorkflow)(req.scope).run({
                        input: {
                            claim_id: id,
            ...
            case 2:
                orderClaim = (_a.sent())[0];
                if (!orderClaim.return_id) return [3 /*break*/, 4];
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.cancelBeginOrderClaimWorkflow)(req.scope).run({
                        input: {
                            claim_id: id,
                        },
                    })];
