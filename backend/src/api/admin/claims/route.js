...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, claims, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), claims = _a.rows, metadata = _a.metadata;
                res.json({
                    claims: claims,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, remoteQuery, orderModuleService, workflow, result, queryObject, _a, order, orderClaim;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                workflow = (0, core_flows_1.beginClaimOrderWorkflow)(req.scope);
            ...
            case 2:
                _a = _b.sent(), order = _a[0], orderClaim = _a[1];
                res.json({
                    order: order,
                    claim: orderClaim[0],
                });
