...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, http_1.refetchEntity)("return_reason", req.params.id, req.scope, req.queryConfig.fields)];
            case 1:
                return_reason = _a.sent();
                if (!return_reason) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "Return reason with id: ".concat(req.params.id, " was not found"));
                }
                res.json({ return_reason: return_reason });
                return [2 /*return*/];
        }
    });
}); };
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, id, input, result, variables, queryObject, remoteQuery, return_reason;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                workflow = (0, core_flows_1.updateReturnReasonsWorkflow)(req.scope);
                id = req.params.id;
                input = {
                    selector: { id: id },
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, input;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                workflow = (0, core_flows_1.deleteReturnReasonsWorkflow)(req.scope);
                input = {
                    ids: [id],
                };
                return [4 /*yield*/, workflow.run({ input: input })];
