...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, filters, taxRegion;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, query, tax_region;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                query = req.scope.resolve(utils_1.ContainerRegistrationKeys.QUERY);
                return [4 /*yield*/, (0, core_flows_1.updateTaxRegionsWorkflow)(req.scope).run({
                        input: [
                            __assign({ id: id }, req.validatedBody),
                        ],
                    })];
            case 1:
                _a.sent();
            ...
            case 2:
                tax_region = (_a.sent()).data[0];
                return [2 /*return*/, res.json({ tax_region: tax_region })];
        }
    });
}); };
exports.POST = POST;
