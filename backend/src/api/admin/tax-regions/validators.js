...
exports.AdminUpdateTaxRegion = exports.AdminCreateTaxRegion = exports.CreateTaxRegion = exports.AdminGetTaxRegionsParams = exports.AdminGetTaxRegionsParamsFields = exports.AdminGetTaxRegionParams = void 0;
...
exports.CreateTaxRegion = zod_1.z.object({
    country_code: zod_1.z.string(),
    provider_id: zod_1.z.string().nullish(),
...
exports.AdminCreateTaxRegion = (0, validators_1.WithAdditionalData)(exports.CreateTaxRegion, function (schema) {
    return schema.refine(function (data) { return data.parent_id || data.provider_id; }, {
        path: ["provider_id"],
