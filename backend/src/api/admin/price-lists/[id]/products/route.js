...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, remove, productPriceIds, workflow, priceList;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                _a = req.validatedBody.remove, remove = _a === void 0 ? [] : _a;
                if (!remove.length) {
            ...
            case 2:
                _b.sent();
                return [4 /*yield*/, (0, helpers_1.fetchPriceList)(id, req.scope, req.queryConfig.fields)];
            case 3:
                priceList = _b.sent();
