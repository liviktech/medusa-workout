...
var fetchPriceList = function (id, scope, fields) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, priceList;
...
var fetchPriceListPriceIdsForProduct = function (priceListId, productIds, scope) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, priceSetIds, variants, _i, variants_1, variant, productPrices;
    var _a;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                for (_i = 0, variants_1 = variants; _i < variants_1.length; _i++) {
                    ...
                    if ((_a = variant.price_set) === null || _a === void 0 ? void 0 : _a.id) {
