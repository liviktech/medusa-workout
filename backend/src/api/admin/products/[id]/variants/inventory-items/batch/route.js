...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, _b, create, _c, update, _d, toDelete, result;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                _a = req.validatedBody, _b = _a.create, create = _b === void 0 ? [] : _b, _c = _a.update, update = _c === void 0 ? [] : _c, _d = _a.delete, toDelete = _d === void 0 ? [] : _d;
