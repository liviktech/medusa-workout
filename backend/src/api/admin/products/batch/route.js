...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.batchProductsWorkflow)(req.scope).run({
                    input: req.validatedBody,
                })];
            case 1:
                result = (_a.sent()).result;
                return [4 /*yield*/, (0, helpers_1.refetchBatchProducts)(result, req.scope, req.queryConfig.fields)];
            case 2:
