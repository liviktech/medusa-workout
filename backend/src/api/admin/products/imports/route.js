...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, transaction;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.importProductsAsChunksWorkflow)(req.scope).run({
                    input: {
            ...
            case 1:
                _a = _b.sent(), result = _a.result, transaction = _a.transaction;
                res
                    .status(202)
