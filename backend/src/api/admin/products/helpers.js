...
var remapKeysForProduct = function (selectFields) {
    ...
    return __spreadArray(__spreadArray([], productFields, true), pricingFields, true);
};
...
var remapKeysForVariant = function (selectFields) {
    ...
    return __spreadArray(__spreadArray([], variantFields, true), pricingFields, true);
};
...
var remapVariantResponse = function (variant) {
    ...
    var resp = __assign(__assign({}, variant), { prices: (_b = (_a = variant.price_set) === null || _a === void 0 ? void 0 : _a.prices) === null || _b === void 0 ? void 0 : _b.map(function (price) { return ({
            id: price.id,
            amount: price.amount,
...
var buildRules = function (price) {
    var rules = {};
    for (var _i = 0, _a = price.price_rules || []; _i < _a.length; _i++) {
        var priceRule = _a[_i];
        var ruleAttribute = priceRule.attribute;
        if (ruleAttribute) {
...
var refetchVariant = function (variantId, scope, fields) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, variant;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                variant = (_a.sent())[0];
                return [2 /*return*/, (0, exports.remapVariantResponse)(variant)];
        }
    });
}); };
...
var refetchBatchProducts = function (batchResult, scope, fields) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), createdRes = _a[0], updatedRes = _a[1];
                return [2 /*return*/, {
                        created: createdRes,
                        updated: updatedRes,
                        deleted: {
...
var buildBatchVariantInventoryData = function (inputs) {
    var _a;
    var results = [];
    for (var _i = 0, _b = inputs || []; _i < _b.length; _i++) {
        var input = _b[_i];
        var result = (_a = {},
            _a[utils_1.Modules.PRODUCT] = { variant_id: input.variant_id },
            _a[utils_1.Modules.INVENTORY] = {
