...
var CreateCampaignBudget = zod_1.z
    .object({
    ...
    return data.type !== utils_1.CampaignBudgetType.SPEND || (0, utils_1.isPresent)(data.currency_code);
}, {
    path: ["currency_code"],
    message: "currency_code is required when budget type is ".concat(utils_1.CampaignBudgetType.SPEND),
})
    .refine(function (data) {
    return data.type !== utils_1.CampaignBudgetType.USAGE || !(0, utils_1.isPresent)(data.currency_code);
}, {
    path: ["currency_code"],
    message: "currency_code should not be present when budget type is ".concat(utils_1.CampaignBudgetType.USAGE),
});
