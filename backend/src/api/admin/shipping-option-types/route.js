...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, _a, shippingOptionTypes, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), shippingOptionTypes = _a.data, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, result, shippingOptionType;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                input = [req.validatedBody];
                return [4 /*yield*/, (0, core_flows_1.createShippingOptionTypesWorkflow)(req.scope).run({
