...
function ensureDbExists(container) {
    return __awaiter(this, void 0, void 0, function () {
        var pgConnection, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, pgConnection.raw("SELECT 1 + 1;")];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    ...
                    if (error_1.code === "3D000") {
                        logger_1.logger.error("Cannot sync links. ".concat(error_1.message.replace("error: ", "")));
