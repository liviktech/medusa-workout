...
var sync_links_1 = require("./sync-links");
var TERMINAL_SIZE = process.stdout.columns;
var cliPath = path_2.default.resolve(framework_1.MEDUSA_CLI_PATH, "..", "..", "cli.js");
/**
...
function migrate(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var container, medusaAppLoader, configModule, plugins, linksSourcePaths, childProcess_1;
        var directory = _b.directory, skipLinks = _b.skipLinks, skipScripts = _b.skipScripts, executeAllLinks = _b.executeAllLinks, executeSafeLinks = _b.executeSafeLinks;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, (0, loaders_1.initializeContainer)(directory)];
                case 1:
                    container = _c.sent();
                ...
                case 5:
                    ...
                    if (!!skipLinks) return [3 /*break*/, 7];
                    console.log(new Array(TERMINAL_SIZE).join("-"));
                    return [4 /*yield*/, (0, sync_links_1.syncLinks)(medusaAppLoader, {
                ...
                case 6:
                    ...
                    _c.label = 7;
                case 7:
                    if (!!skipScripts) return [3 /*break*/, 9];
                    /**
                     * Run migration scripts
                     */
                    console.log(new Array(TERMINAL_SIZE).join("-"));
                    childProcess_1 = (0, child_process_1.fork)(cliPath, ["db:migrate:scripts"], {
                        cwd: directory,
                        env: process.env,
                    });
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            childProcess_1.on("error", function (error) {
                                reject(error);
                            });
                            childProcess_1.on("close", function () {
                                resolve();
                            });
                        })];
                case 8:
            ...
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, migrate({
                            ...
                            executeAllLinks: executeAllLinks,
                            executeSafeLinks: executeSafeLinks,
                        })];
                case 1:
                    migrated = _c.sent();
