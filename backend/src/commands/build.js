...
function build(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var compiler, tsConfig, promises, bundler, responses;
        var directory = _b.directory, adminOnly = _b.adminOnly;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require("@medusajs/admin-bundler"); })];
                case 2:
                    bundler = _c.sent();
                ...
                case 3:
                    responses = _c.sent();
                    if (responses.every(function (response) { return response === true; })) {
                        process.exit(0);
                    }
                    else {
                        process.exit(1);
